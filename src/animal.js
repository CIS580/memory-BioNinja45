...
/**
 * @module exports the Animal class
 */
...
Animal.prototype.leftSpritesheet = new Image();
Animal.prototype.leftSpritesheet.src = 'assets/fang/fang left.png';
Animal.prototype.rightSpritesheet = new Image();
Animal.prototype.rightSpritesheet.src = 'assets/fang/fang right.png';

/**
 * @function updates the player object
 * {DOMHighResTimeStamp} time the elapsed time since the last frame
 */
Animal.prototype.update = function(elapsedTime) {
 ...
 */
Animal.prototype.render = function(time, ctx) {
  if(this.state == "right") {
    ctx.drawImage(
      // image
